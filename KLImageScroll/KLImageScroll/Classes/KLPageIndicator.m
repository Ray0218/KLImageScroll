...
-(UIImageView*)rIndicatorImg {
    if (!_rIndicatorImg) {
        ...
        _rIndicatorImg.image = [UIImage kl_ImageWithColor:[UIColor lightGrayColor]  size:CGSizeMake(CGRectGetWidth(self.bounds),CGRectGetWidth(self.bounds)) isCircle:YES];
        _rIndicatorImg.highlightedImage = [UIImage kl_ImageWithColor:[UIColor blackColor]  size:CGSizeMake(CGRectGetWidth(self.bounds),CGRectGetWidth(self.bounds)) isCircle:YES]  ;
